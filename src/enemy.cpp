    ...
    // : pos(pos.x, pos.y)
{
    ...
    switch((int)type) {
        case DEADBEAT:
        collider.radius = 10;
        runAnimation[0] = window.loadTexture("res/gfx/spr_Deadbeat/spr_Deadbeat_0.png");
        runAnimation[1] = window.loadTexture("res/gfx/spr_Deadbeat/spr_Deadbeat_1.png");
        runAnimation[2] = window.loadTexture("res/gfx/spr_Deadbeat/spr_Deadbeat_2.png");
        break;
        case SHRIMP:
        collider.radius = 14;
        runAnimation[0] = window.loadTexture("res/gfx/spr_Shrimp/spr_Shrimp_0.png");
        runAnimation[1] = window.loadTexture("res/gfx/spr_Shrimp/spr_Shrimp_1.png");
        runAnimation[2] = window.loadTexture("res/gfx/spr_Shrimp/spr_Shrimp_2.png");
        break;
    }
}
...
void spawn(std::vector<Enemy>& enemies, RenderWindow window, Vector2f playerPos) {
    ...
    enemies.push_back(Enemy{SHRIMP, spawnPos, window});
}
